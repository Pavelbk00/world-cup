      ...
      <div className="rules-grid">
        ...
        <section className="rule-card">
          <h4>
            ...
            4. Плей-офф: победитель матча
          </h4>
          <p>
            Бонус за угаданного победителя матча плей-офф (проход в следующую
            стадию).
          </p>
          <ul>
            <li>
              <strong>+1 очко</strong> — если угадана команда, прошедшая дальше.
            </li>
          </ul>
        </section>
        ...
        <section className="rule-card">
          ...
          <p>
            Одна ставка до старта турнира. Очки начисляются после финала
            чемпионата мира.
          </p>
          <ul>
            <li>
        ...
        <section className="rule-card">
          ...
          <p>
            Долгосрочные ставки на топ-3 команды чемпионата. Прогноз принимается{" "}
            <strong>строго до начала первого матча турнира</strong> — после
            старта изменить выбор нельзя. Очки начисляются после финала
            чемпионата мира.
          </p>
          <ul>
            <li>
