    ...
    <div className="rules">
      ...
      <div className="rules-grid">
        ...
        <section className="rule-card">
          ...
          <p>Одна ставка до старта турнира. Очки начисляются после финала чемпионата мира.</p>
          <ul>
            <li>
        ...
        <section className="rule-card">
          ...
          <p>Долгосрочные ставки на топ-3 команды чемпионата. Прогноз принимается <strong>строго до начала первого матча турнира</strong> — после старта изменить выбор нельзя. Очки начисляются после финала чемпионата мира.</p>
          <ul>
            <li>
